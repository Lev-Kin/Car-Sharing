...
public class Menu {
            ...
            switch (userChoice()) {
                ...
                case 1:
                    if (companyDaoH2.getAllCompanies().size() == 0) {
                        ...
                        companyDaoH2.getAllCompanies().forEach(System.out::println);
    ...
    public static void managementCustomerMenu(CustomerDaoH2Impl customerDaoH2,
        ...
        if (customerDaoH2.getAllCustomers().size() == 0) {
            ...
            customerDaoH2.getAllCustomers().forEach(System.out::println);
            System.out.println("0. Back\n");
